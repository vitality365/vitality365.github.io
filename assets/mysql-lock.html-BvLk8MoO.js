import{_ as e,c as o,a as t,o as p}from"./app-D95YKyTd.js";const r={};function s(c,n){return p(),o("div",null,n[0]||(n[0]=[t(`<h1 id="mysql表锁、行锁、共享锁、排他锁、乐观锁、悲观锁" tabindex="-1"><a class="header-anchor" href="#mysql表锁、行锁、共享锁、排他锁、乐观锁、悲观锁"><span>MySql表锁、行锁、共享锁、排他锁、乐观锁、悲观锁</span></a></h1><p>表锁</p><pre><code>锁住整个表。
